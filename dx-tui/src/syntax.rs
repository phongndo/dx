...
use dx_diff::{Changeset, DiffLine, DiffLineKind, DiffOptions, DiffScope, DiffSource};
use dx_syntax::{
...
impl SyntaxRuntime {
    pub(crate) fn start(settings: &SyntaxSettings) -> DxResult<Option<Self>> {
...
pub(crate) fn syntax_path(file: &dx_diff::DiffFile, side: DiffSide) -> Option<&str> {
    match side {
...
pub(crate) fn file_path_for_side(file: &dx_diff::DiffFile, side: DiffSide) -> Option<&str> {
    match side {
