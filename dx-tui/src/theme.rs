...
pub(crate) const HELP_MENU_RIGHT_ROWS: &[HelpMenuRow] = &[
    ...
    HelpMenuRow::Binding("1-9", "select diff menu item"),
    ...
    HelpMenuRow::Section("Selector filter"),
    HelpMenuRow::Binding("type", "filter choices"),
    HelpMenuRow::Binding("Enter", "select match"),
